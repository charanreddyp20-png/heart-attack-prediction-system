...
def analysis():
    ...
    try:
        I=selection3()
         ...
         messagebox.showerror("missing","Please select examg!!")
         return
    try:
        C=int(selection4())
    except:
...
#info
    ...
    Label( Icon_window,text="cp - chest pain hype (0 = typical angina; 1 = atypical angina; 2 = non-anginal pain; 3 = asymptomatic)  ",font="arial 11").place(x=20,y=160)
    ...
    Label( Icon_window,text="fbs - fasting blood suger > 120 mg/dl (1 = true;0 = false)",font="arial 11").place(x=20,y=250)
...
cp_combobox=Combobox(Detail_entry,values=['0 = typical angine','1 = atypical angina','2 = non-anginal pain','3 = asymptomatic'],font="arial 12",state="r",width=14)
...
mode=Button(root,image=smoking_icon,bg="#dbe0e3",bd=0,cursor="hand2",command=changmode)
